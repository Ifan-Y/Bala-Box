...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.do_botton.setGeometry(QtCore.QRect(70, 530, 131, 41))
        ...
        self.rename_progress_bar.setGeometry(QtCore.QRect(260, 540, 331, 23))
        self.rename_progress_bar.setProperty("value", 24)
        self.rename_progress_bar.setObjectName("rename_progress_bar")
        self.check_split_box = QtWidgets.QCheckBox(self.centralwidget)
        self.check_split_box.setGeometry(QtCore.QRect(50, 470, 261, 41))
        self.check_split_box.setObjectName("check_split_box")
        self.train_proportion_box = QtWidgets.QSpinBox(self.centralwidget)
        self.train_proportion_box.setGeometry(QtCore.QRect(380, 480, 61, 22))
        self.train_proportion_box.setObjectName("train_proportion_box")
        self.val_proportion_box = QtWidgets.QSpinBox(self.centralwidget)
        self.val_proportion_box.setGeometry(QtCore.QRect(451, 480, 61, 22))
        self.val_proportion_box.setObjectName("val_proportion_box")
        self.test_proportion_box = QtWidgets.QSpinBox(self.centralwidget)
        self.test_proportion_box.setGeometry(QtCore.QRect(530, 480, 61, 22))
        self.test_proportion_box.setObjectName("test_proportion_box")
        self.split_label = QtWidgets.QLabel(self.centralwidget)
        self.split_label.setGeometry(QtCore.QRect(320, 470, 281, 41))
        self.split_label.setFrameShape(QtWidgets.QFrame.Panel)
        self.split_label.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.split_label.setObjectName("split_label")
        self.split_label.raise_()
        ...
        self.check_split_box.raise_()
        self.train_proportion_box.raise_()
        self.val_proportion_box.raise_()
        self.test_proportion_box.raise_()
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.check_split_box.setText(_translate("MainWindow", "拆分为训练、验证、测试集"))
        self.split_label.setText(_translate("MainWindow", "比例"))
